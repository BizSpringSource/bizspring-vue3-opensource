    ...
    <el-row v-loading="loading">
      <el-col :span="24" class="card-box">
        <el-card>
          ...
          <div class="el-table el-table--enable-row-hover el-table--small">
...
<script>
import { getCache } from '@/api/upms/cache'
          ...
          series: [
            {
              ...
              radius: [15, 95],
              center: ['50%', '38%'],
              data: response.data.data.commandStats,
