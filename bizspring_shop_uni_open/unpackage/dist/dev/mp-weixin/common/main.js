...
/***/ 0:
/*!********************************************************************!*\
  !*** C:/IDEA_Space/bizspring-open/bizspring_shop_uni_open/main.js ***!
  \********************************************************************/
...
/***/ 27:
/*!********************************************************************!*\
  !*** C:/IDEA_Space/bizspring-open/bizspring_shop_uni_open/App.vue ***!
  \********************************************************************/
/*! no static exports found */
...
/***/ 28:
/*!*********************************************************************************************!*\
  !*** C:/IDEA_Space/bizspring-open/bizspring_shop_uni_open/App.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 29:
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/IDEA_Space/bizspring-open/bizspring_shop_uni_open/App.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request.js */ 34));
var _default = {
  globalData: (0, _defineProperty2.default)({
    navHeight: 0,
    userInfo: null,
    user: null,
    userType: "",
  ...
  methods: {
    wxUpdateManager: function wxUpdateManager() {
      // 版本更新  
    ...
    onAuth: function onAuth() {
      var _this2 = this;
      var userInfoStorage = uni.getStorageSync('userInfoStorage');
      if (userInfoStorage) {
        var rf_token = userInfoStorage.refresh_token;
        uni.showLoading({
          title: 'Loading...'
        });
        (0, _login.refreshToken)(rf_token).then(function (response) {
          uni.hideLoading();
          if (response.data.user) {
            _this2.setAuthorization('Bearer ' + response.data.access_token);
            _this2.setUserId(response.data.user.id);
            _this2.setUsername(response.data.user.username);
            _this2.globalData.userInfo = response.data.user;
            _this2.loginSetStorage(response.data);
          } else {
            _this2.logoutRemoveStorage();
          }
          // resolve();
    ...
    loginSetStorage: function loginSetStorage(e) {
      uni.setStorageSync('userInfoStorage', e);
    },
    //删除登录storage 信息，删除保持登录  删
    logoutRemoveStorage: function logoutRemoveStorage() {
    ...
    setHanderMessages: function setHanderMessages(messages) {
...
/***/ 37:
/*!*****************************************************************************************************!*\
  !*** C:/IDEA_Space/bizspring-open/bizspring_shop_uni_open/App.vue?vue&type=style&index=0&lang=css& ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
